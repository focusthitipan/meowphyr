...
export const TURBO_EDITS_PROMO_MESSAGE: MessageConfig = {
  spans: [
    ...
    { type: "link", content: " Get Meowphyr Pro", url: "https://dyad.sh/pro#ai" },
...
export const SMART_CONTEXT_PROMO_MESSAGE: MessageConfig = {
  spans: [
    ...
    {
      type: "link",
      content: "Meowphyr Pro's Smart Context",
...
export const BUILD_A_BIBLE_APP_TIP: MessageConfig = {
  spans: [
    ...
    {
      type: "text",
      content: " the creator of Meowphyr build a Bible app step-by-step",
    },
  ],
};
...
// Like Meowphyr? Star it on GitHub https://github.com/dyad-sh/dyad/
export const GITHUB_TIP: MessageConfig = {
  spans: [
    {
      type: "text",
      content: "Like Meowphyr? Star it on ",
    },
    {
      type: "link",
      content: "GitHub",
